...
def _draw_grid(
    ...
    for b in env.bodies.values():
        ...
        col = GRID_PRED if b.team == gt.TEAM_PREDATOR else GRID_PREY
...
def run_visualization(config: SimulationConfig) -> None:
    pygame.init()
    ...
    pygame.display.set_caption("Predator–prey grid")
    ...
    def status_text() -> str:
        return f"{sim.status_line()}  |  seed={config.seed}"
